    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
						<div class="form-group"
							<label for="patient_name" class="control-label">Client</label>
						 ...
						 <div class="form-group"
							<label for="doctor" class="control-label">Attorney</label>
    	...
    	<div class="modal-dialog">    		
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="p_gender" class="control-label">Attorney:</label>				
